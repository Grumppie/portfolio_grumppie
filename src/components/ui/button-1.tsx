    ...
    return (
        <div className="flex justify-start w-full">
            <a
                href={href}
                target={target}
                className="relative inline-block w-full h-[3em] group dark:bg-black bg-white dark:border-white/20 border-black/20 border rounded-xl"
            >
                <div className="absolute w-[112.81%] h-[128.57%] top-[8.57%] left-1/2 -translate-x-1/2 filter blur-[19px] opacity-70">
                    <span className="absolute inset-0 rounded-xl bg-[#d9d9d9] filter blur-[6.5px]"></span>
                    <div className="relative w-full h-full overflow-hidden rounded-xl">
                        <Liquid isHovered={isHovered} colors={SHARED_COLORS} />
                    </div>
                </div>
                ...
                <button
                    className="absolute inset-0 rounded-xl bg-transparent cursor-pointer w-full"
                    aria-label={label}
                    type="button"
                    onMouseEnter={() => setIsHovered(true)}
                    onMouseLeave={() => setIsHovered(false)}>
                    <span className="flex items-center justify-center sm:justify-start px-6 h-full gap-4 rounded-xl text-white text-lg font-semibold tracking-wide whitespace-nowrap">
                        <Icon className="fill-white/10 stroke-white w-6 h-6 flex-shrink-0" />
    ...
    return (
        <div className="flex justify-start w-full">
            ...
            >
                ...
                <div className="absolute inset-0 rounded-xl bg-transparent w-full flex items-center justify-center pointer-events-none">
                    <span className="text-white text-lg font-bold tracking-widest whitespace-nowrap z-10 px-6 drop-shadow-md">
                        {label}
                    </span>
                </div>
            </button>
