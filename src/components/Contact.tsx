...
export function Contact() {
    return (
        <section id="contact" className="relative w-full py-32 flex flex-col items-center justify-center bg-black overflow-hidden border-t border-white/10">
            ...
            <div className="relative z-10 w-full max-w-5xl px-4 flex flex-col items-center text-center">
                <h2 className="text-5xl md:text-7xl font-bold tracking-tight text-white mb-8" style={{ fontFamily: "'Outfit', sans-serif" }}>
                    Begin Transmission
                </h2>

                <p className="text-zinc-400 max-w-2xl text-lg md:text-xl font-light tracking-wide mb-16 leading-relaxed">
                ...
                <div className="w-full text-left">
                    ...
                    >
                        <form action="https://api.web3forms.com/submit" method="POST" className="w-full space-y-6">
                            ...
                            <div className="flex flex-col gap-2">
                                ...
                                <Textarea id="message" name="message" placeholder="How can I help you?" required className="min-h-[120px] resize-none" />
                            </div>
                            <div className="pt-2">
                                <SubmitSocialButton label="LET THERE BE LIGHT" />
                            </div>
                        </form>
                    </ContactCard>
                </div>
